...
public class ModelTests {
    ...
    public void testTrackSetTempo() {
        Track t = new Track(new ArrayList<Note>(), 4);
        assertEquals(t.getTempo(), 4);

        t.setTempo(60);
        assertEquals(t.getTempo(), 60);

        Track t2 = new Track(new ArrayList<Note>(), 0);
    ...
    public void testTrackAddNote() {
        Track t = new Track(new ArrayList<Note>(), 0);
    ...
    public void testTrackGetLength() {
        ...
        Track emptyT = new Track(new ArrayList<Note>(), 0);
