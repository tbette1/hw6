...
public class ModelTests {
    ...
    public void testNoteCompareTo() {
        ...
        assertEquals(c4.compareTo(cSharp4) < 0, true);
        assertEquals(c4.compareTo(c3) > 0, true);
        assertEquals(c4.compareTo(c5) < 0, true);
        assertEquals(cSharp4.compareTo(c4) > 0, true);
        assertEquals(c3.compareTo(c4) < 0, true);
        assertEquals(c5.compareTo(c4) > 0, true);
    }
